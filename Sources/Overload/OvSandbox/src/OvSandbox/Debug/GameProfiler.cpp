...
OvSandbox::Debug::GameProfiler::GameProfiler(OvWindowing::Window& p_window, float p_frequency) : m_frequency(p_frequency), m_window(p_window)
{
...
void OvSandbox::Debug::GameProfiler::Update(float p_deltaTime)
{
...
OvUI::Types::Color OvSandbox::Debug::GameProfiler::CalculateActionColor(double p_percentage) const
{
...
std::string OvSandbox::Debug::GameProfiler::GenerateActionString(OvAnalytics::Profiling::ProfilerReport::Action & p_action)
{
	std::string result;
